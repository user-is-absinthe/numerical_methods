...
def point_to_point(size_of_img, home):
    ...
    for pixel_x in range(size_of_img[0]):
        ...
        #     if pixel_x == home[i, 0]:
        #         big_grid.append([pixel_x, home[i, 1]])
        #         # next(pixel_x)
        #         # TODO: пропуск итерации цикла для известного у
        #         continue

        # TODO: находить у для рандомной точки
        # используем для этого отдельную функцию
        # pixel_x = 0.3
        sorted_for_this = sort_for_random_y(pixel_x, home[:, 0])
        # print('\nFor this x={0}, sorted table:\n'.format(pixel_x), sorted_for_this)
        # print(home[:, 0])
        # ТУТ КАКАЯ-ТО ХЕРНЯ:
...
if __name__ == '__main__':
    ...
    path_to_file = '/Users/owl/Pycharm/PycharmProjects/numerical_methods/img/RevInt7.bmp'
