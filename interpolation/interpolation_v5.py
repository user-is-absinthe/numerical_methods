...
def newton(path_to_file, arguments):
    ...
    if len(arguments) == 0:
        ...
        # grid_array = read_img(path=path_to_file)
        grid_array = cut_the_grid(array=arguments, grid=read_img(path=path_to_file))
...
if __name__ == '__main__':
    # path_to_file = '/Users/owl/Pycharm/PycharmProjects/numerical_methods/img/RevInt2.bmp'
